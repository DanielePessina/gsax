...
results. The repository's [`CITATION.cff`](CITATION.cff) contains the current
software-citation metadata. If a version-specific DOI is available, use that
DOI; otherwise cite the corresponding Git tag or GitHub release. Also cite the
