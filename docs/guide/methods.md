...
The walkthrough above is the long version; this is the one-line version. It is the condensed table from the eight-method comparison on [Ishigami](/examples/method-comparison), and "Best for" names the job each method does best at a small evaluation budget.

| Method | Best for |
| --- | --- |
| [Sobol'](#sobol-indices-via-saltelli-sampling) | Gold standard for $S_2$ |
| [eFAST](#efast-extended-fourier-amplitude-sensitivity-test) | Screening at $N \times D$ |
| [DGSM](#dgsm-derivative-based-global-sensitivity-measures) | Differentiable models via autodiff |
| [HDMR](#rs-hdmr-random-sampling-high-dimensional-model-representation) | Arbitrary $(X, Y)$ data |
| [PCE](#pce-polynomial-chaos-expansion) | Emulation with a reusable surrogate |
| [Morris](#morris-elementary-effects-screening) | Cheapest screening / factor fixing |
| [Shapley](#shapley-effects) | Fair variance shares summing to 1 |
| [Borgonovo delta](#borgonovo-delta-density-based-sensitivity) | Moment-independent influence on the whole output density |
...
diffuse [0.0452387  0.05261128 0.09583226]
```
